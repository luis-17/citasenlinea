        ...
        <div class="row">
          <div class="col-md-12 col-xs-12 col-sm-12 ">                  
              <div class="tab-heading ">
                  ...
                  <div>
                    <h2 class="title">Resultados de Laboratorio</h2> 
                    <p class="descripcion">Lista General de Resultados.</p>
                    <blockquote>
                        <small style="color:#36c5df;">Paciente : <ins><strong class="text-teals">{{ fSessionCI.nombres }} {{ fSessionCI.apellido_paterno}} {{ fSessionCI.apellido_materno }} </strong></ins></small>              
                    </blockquote>
                  </div>
              </div>
          </div>
