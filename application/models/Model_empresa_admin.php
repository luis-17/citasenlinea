...
class Model_empresa_admin extends CI_Model { 
	...
	{
		$this->db->select('sea.idsedeempresaadmin, ea.idempresaadmin, s.idsede, razon_social, s.descripcion');
		$this->db->from('empresa_admin ea');
	...
	{
		$this->db->select('idsedeempresaadmin, ea.idempresaadmin, ea.razon_social, s.descripcion AS sede,
